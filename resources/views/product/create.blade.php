  <x-app-layout>
    ...
    <div class="flex mb-4 px-4">
        ...
        <form class="w-full max-w-sm" action="{{route('subcategory.store')}}" method="post">
            @csrf
                <div class="md:w-1/2 md:items-center mb-6">
                  ...
                  <div class="md:w-3/2">
                    <textarea class="resize-x border rounded focus:outline-none focus:shadow-outline"
                                    name="description" id="description" @error('quantity') is-invalid @enderror" cols="50" rows="10">
                                  </textarea>
                    @error('description')
                        <div class="bg-orange-100 border-orange-500 text-orange-700 p-4" role="alert">
