<x-app-layout>
    ...
    <div class="flex mb-4 px-4">
      @include('include.leftmenu')
        ...
        <form class="w-full max-w-sm" action="{{route('category.update',$category->id)}}" method="post">
            @csrf
            @method('PUT')
                <div class="md:flex md:items-center mb-6">
                  ...
                  id="name" name="name" type="text" value="{{$category->name}}" @error('name') is-invalid @enderror">
                    @error('name')
